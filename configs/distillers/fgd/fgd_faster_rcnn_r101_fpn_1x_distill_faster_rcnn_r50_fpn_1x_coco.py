...
distiller = dict(
    ...
    teacher_pretrained = '/home/host/jp/FGD-master/faster_rcnn_r101_fpn_1x_coco_20200130-f513f705.pth',
    init_student = True,
    distill_cfg = [ dict(student_module = 'neck.reduce_layers.0.conv',
